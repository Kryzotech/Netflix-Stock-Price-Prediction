...
#     high_val = st.number_input('High Value')
#     low_val = st.number_input('Low Value')
#     adj_close_val = st.number_input('Adjusted Close Value')
#     volume_val = st.number_input('Volume')
#     year_val = st.number_input('Year', min_value=2000, max_value=2023)
#     month_val = st.number_input('Month', min_value=1, max_value=12)
#     day_val = st.number_input('Day', min_value=1, max_value=31)
#
